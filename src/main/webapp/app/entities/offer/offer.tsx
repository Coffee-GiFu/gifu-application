              ...
              <React.Fragment>
                {offerList.map((offer, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{offer.title}</td>
                    <td>{offer.location ?
                      <Link to={`location/${offer.location.id}`}>{offer.location.city}</Link> : ''}</td>
                    <td>{offer.recuperator ?
                      <Link to={`recuperator/${offer.recuperator.id}`}>{offer.recuperator.name}</Link> : ''}</td>
