    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="gifuApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gifuApp.location.home.createLabel">Create a new Location</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {locationList && locationList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="gifuApp.location.home.notFound">No Locations found</Translate>
            </div>
          )}
        </div>
      </div>
